...
<table style="border-collapse: collapse; width: 100%; text-align: center;">
    ...
    <tbody>
        <tr>
            <td style="border: 1px solid #ddd; padding: 8px; vertical-align: middle;">김용민</td>
        ...
        <tr>
            <td style="border: 1px solid #ddd; padding: 8px; vertical-align: middle;">신관우</td>
        ...
        <tr>
            <td style="border: 1px solid #ddd; padding: 8px; vertical-align: middle;">김민식</td>
            <td style="border: 1px solid #ddd; padding: 8px; vertical-align: middle;">소프트웨어학과</td>
        ...
        <tr>
            <td style="border: 1px solid #ddd; padding: 8px; vertical-align: middle;">방민경</td>
        ...
        <tr>
            <td style="border: 1px solid #ddd; padding: 8px; vertical-align: middle;">유성환</td>
...
<table style="border-collapse: collapse; width: 100%; text-align: center;">
    ...
    <tbody>
        <tr>
            <td style="border: 1px solid #ddd; padding: 10px; vertical-align: middle;">대학원생 인터뷰</td>
            ...
            <td style="border: 1px solid #ddd; vertical-align: middle;">
                <img src="https://github.com/user-attachments/assets/eed61b1f-8a66-4f0e-9f12-28a93c91de94" alt="대학원생 인터뷰" style="width: 800px; height: auto;">
            </td>
        </tr>
        <tr>
            <td style="border: 1px solid #ddd; padding: 10px; vertical-align: middle;">보직 교수님 면담</td>
            ...
            <td style="border: 1px solid #ddd; vertical-align: middle;">
                <img src="https://github.com/user-attachments/assets/3bc3510f-be8f-4fe3-b2ed-50f2cfd8a0e5" alt="보직 교수님 면담" style="width: 800px; height: auto;">
            </td>
        </tr>
        <tr>
            <td style="border: 1px solid #ddd; padding: 10px; vertical-align: middle;">정보통신처 탐방</td>
            ...
            <td style="border: 1px solid #ddd; vertical-align: middle;">
                <img src="https://github.com/user-attachments/assets/b13caca7-74a2-4e45-8f8e-ef7d5c79df09" alt="정보통신처 탐방" style="width: 800px; height: auto;">
            </td>
        </tr>
        <tr>
            <td style="border: 1px solid #ddd; padding: 10px; vertical-align: middle;">소융대 멘토링</td>
            ...
            <td style="border: 1px solid #ddd; vertical-align: middle;">
                <img src="https://github.com/user-attachments/assets/e9973594-802f-4083-bf24-106de361846d" alt="소융대 멘토링" style="width: 800px; height: auto;">
            </td>
        </tr>
        <tr>
            <td style="border: 1px solid #ddd; padding: 10px; vertical-align: middle;">행정실 탐방</td>
            ...
            <td style="border: 1px solid #ddd; vertical-align: middle;">
                <img src="https://github.com/user-attachments/assets/5e542138-f81c-4fb7-a705-3a90974ab2cc" alt="행정실 탐방" style="width: 800px; height: auto;">
            </td>
        </tr>
    </tbody>
</table>
...
<table style="border-collapse: collapse; width: 100%; text-align: center;">
    ...
    <tbody>
        <tr>
            <td style="border: 1px solid #ddd; padding: 10px; vertical-align: middle;">김용민</td>
        ...
        <tr>
            <td style="border: 1px solid #ddd; padding: 10px; vertical-align: middle;">신관우</td>
            <td style="border: 1px solid #ddd; padding: 10px; vertical-align: middle;">
        ...
        <tr>
            <td style="border: 1px solid #ddd; padding: 10px; vertical-align: middle;">김민식</td>
            <td style="border: 1px solid #ddd; padding: 10px; vertical-align: middle;">
        ...
        <tr>
            <td style="border: 1px solid #ddd; padding: 10px; vertical-align: middle;">방민경</td>
            <td style="border: 1px solid #ddd; padding: 10px; vertical-align: middle;">
        ...
        <tr>
            <td style="border: 1px solid #ddd; padding: 10px; vertical-align: middle;">유성환</td>
            <td style="border: 1px solid #ddd; padding: 10px; vertical-align: middle;">
